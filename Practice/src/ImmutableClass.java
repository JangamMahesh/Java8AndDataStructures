...
public final class ImmutableClass {
	...
	public static void main(String[] args) {
		...
		// singleton and immutable are different , single we can have single instance for app
		// immutable we can have so many instances but once assigned values cannot be changed
		ImmutableClass ce1 = new ImmutableClass(i, s, h1);
